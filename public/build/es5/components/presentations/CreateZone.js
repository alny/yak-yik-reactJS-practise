    ...
    render: {
      value: function render() {
        return React.createElement(
          "div",
          null,
          React.createElement("input", { id: "name", onChange: this.updateZone.bind(this), className: "form-control", placeholder: "Zone" }),
          React.createElement("br", null),
          React.createElement("input", { id: "zipCode", onChange: this.updateZone.bind(this), className: "form-control", type: "text", placeholder: "ZipCode" }),
          React.createElement("br", null),
          React.createElement(
            "button",
